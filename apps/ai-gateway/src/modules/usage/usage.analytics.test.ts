...
function usageEvent(overrides: Partial<AiUsageEvent>): AiUsageEvent {
  ...
  return {
    ...
    billingMode: overrides.billingMode ?? 'user_provider',
    requestId: overrides.requestId ?? null,
    upstreamRequestId: overrides.upstreamRequestId ?? null,
    internalProviderId: overrides.internalProviderId ?? null,
    internalProviderModelId: overrides.internalProviderModelId ?? null,
    creditLedgerEntryId: overrides.creditLedgerEntryId ?? null,
    usageEstimated: overrides.usageEstimated ?? false,
