...
| [**Blueprint Aesthetic**](./blueprint-aesthetic.md) | **结构装饰层**——zed 式工程纸/蓝图语汇（五段框架、骑线节点、标尺、条码、斜纹、物理感按钮）。**调色板以落地页为准**，与 design-system.md 成对 | ✅ |
| [Design System](./design-system.md) | 材质层——暖白柔面哑光 token / 色彩 / Surface 契约（蓝图语汇见 Blueprint Aesthetic） | ✅ |
...
> **设计文档分工**：[design-system.md](./design-system.md) 管「用什么材料」（暖哑光 token / 色彩 / Surface 材质），[blueprint-aesthetic.md](./blueprint-aesthetic.md) 管「结构怎么长出来」（zed 式工程图纸语汇）。落地页 `apps/web/src/routes/index.tsx` 是两者的最佳范本。
