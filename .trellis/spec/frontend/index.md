...
> dicha-life 前端开发约定。栈：React 19 + Vite + TanStack Router/Query + ts-rest + Zustand + Lobe UI / Ant Design（Tailwind v4）。
...
| [Component Guidelines](./component-guidelines.md) | 组件模式、Lobe UI/AntD、Pixi 边界 | ✅ M1 骨架 |
